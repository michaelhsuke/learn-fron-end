...
btn_1111 =  wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, '#J_babelOptPage > div > div.bab-opt-mod.bab-opt-mod-1_8.free_coupon > div > div >  a:nth-child(1)')))

count = 0
while count < 1000:
  count = count + 1
  print('点击了{0}次'.format(count))
  browser.execute_script('document.querySelector("#J_babelOptPage > div > div.bab-opt-mod.bab-opt-mod-1_8.free_coupon > div > div >  a:nth-child(1)").click()')
  sleep(1)
# print('第一次点击')
# sleep(3)
# btn_1111.click()
